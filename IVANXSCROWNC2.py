...
\033[36m                               ║╚╗╔╝╠═╣║║\033[37m║╠═╝║ ║║ ║╠═╝
\033[36m                               ╩ ╚╝ ╩ ╩╝╚╝╩  \033[37m╚═╝╚═╝╩  
\033[36m                                 IVANPOOP M\033[37mY IVANBEER
...
banner =  """
\033[36m                ╔═══════════════════════════════════════════════╗
\033[36m                ║\033[37m- - - - - - - IVANPOOP C2 By \033[37m@IVANBEER C2 \033[37m- - - - - - -\033[36m ║
\033[36m                ║\033[37m  - - - Type \033[37mhelp\033[37m to see the Help Menu - - -\033[36m   ║
\033[36m                ╚═══════════════════════════════════════════════╝
\033[36m                       ╔══════════════════════════════════╗
\033[36m                       ║\033[37m- Connection Has Been \033[37m[20/02/2024]║
\033[36m                       ╚══════════════════════════════════╝
\033[36m                    ╔════════════════════════════════════════╗
...
def main():
	...
	while True:
		bots = (random.randint(102468,100666545))
		avi = (random.randint(55055,666666))
		sys.stdout.write("\x1b]2;IVANPOOP. | Devices: [{}] | Spoofed Servers [99999] | Server Units [99999] | Clients: [99999]\x07".format (bots))
		sin = input("\033[36m[\033[36m{}\033[37m@IVANBEER\033[36m]\033[32m$ \033[36m".format(nicknm)).lower()
		sinput = sin.split(" ")[0]
		if sinput == "clear":
			os.system ("clear")
			print (banner)
